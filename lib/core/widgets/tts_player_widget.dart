                    ...
                    _buildControlButton(
                      ...
                      onPressed: () async {
                        if (widget.currentPage > 0) {
                          final prevPage = widget.currentPage - 1;
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: color.withValues(alpha: isOn ? 0.7 : 0.3),
            width: 1.5,
          ),
          boxShadow: isOn
              ? [
                              ...
                              return GestureDetector(
                                ...
                                child: AnimatedContainer(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                      color: isSelected
                                          ? charColor.withValues(alpha: 0.5)
                                          : (isDark
                                                ? Colors.white10
                                  ...
                                  child: Row(
                                    children: [
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          shape: BoxShape.circle,
                                          color: charColor.withValues(alpha: 
                                            isSelected ? 0.2 : 0.1,
                                          ),
                                        ),
                                        child: Center(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: isSelected
                          ? [
                              charColor.withValues(alpha: 0.25),
                              charColor.withValues(alpha: 0.10),
                            ]
                          : isDark
                          ? [
                              Colors.white.withValues(alpha: 0.07),
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: 8,
                          color: isSelected
                              ? charColor.withValues(alpha: 0.8)
                              : Colors.grey.shade400,
                          fontWeight: FontWeight.w700,
                          letterSpacing: 0.5,
                        ),
