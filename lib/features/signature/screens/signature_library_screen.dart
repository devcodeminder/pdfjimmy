...
import 'package:pdfjimmy/core/widgets/signature_pad.dart';
import '../screens/signature_template_screen.dart';
import 'package:pdfjimmy/features/scanner/presentation/image_crop_screen.dart';

import '../screens/signature_view_screen.dart';
import '../screens/signature_pdf_placer_screen.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              _buildPremiumOption(
                ...
                title: 'Add to PDF',
                subtitle: 'Place this signature on a PDF',
                onTap: () {
                  Navigator.pop(context);
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const SignaturePdfPlacerScreen(),
                    ),
                  );
                },
              ),
