...
class PdfBuilder {
  ...
  static Future<File> createPdfFromImages({
    ...
    final bytes = await createPdfBytesFromImages(
  ...
  /// Creates a PDF from a list of image paths and returns its bytes.
  static Future<Uint8List> createPdfBytesFromImages({
    required List<String> imagePaths,
    List<String>? extractedText,
  }) async {
