    ...
    try {
      if (_imageData != null) {
        ...
        if (image != null) {
          ...
          int minX = w, maxX = 0, minY = h, maxY = 0, docs = 0;
          for (int y = sy; y < ey; y += 10) {
            for (int x = sx; x < ex; x += 10) {
          ...
          if (docs > 30 && minX < maxX && minY < maxY) {
            double cx = (minX + maxX) / 2 / w;
            double cy = (minY + maxY) / 2 / h;
            double szX = (maxX - minX) / 2 / w + 0.01;
            double szY = (maxY - minY) / 2 / h + 0.01;
            _cropPoints = [
              Offset((cx - szX).clamp(0.0, 1.0), (cy - szY).clamp(0.0, 1.0)),
              Offset((cx + szX).clamp(0.0, 1.0), (cy - szY).clamp(0.0, 1.0)),
              Offset((cx + szX).clamp(0.0, 1.0), (cy + szY).clamp(0.0, 1.0)),
              Offset((cx - szX).clamp(0.0, 1.0), (cy + szY).clamp(0.0, 1.0)),
            ];
          ...
          AnimatedBuilder(
            ...
            builder: (_, __) => Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: _neonPurple.withOpacity(_glow.value),
                  width: 2,
                ),
                boxShadow: [
                  BoxShadow(
                    color: _neonPurple.withOpacity(0.3 * _glow.value),
                    blurRadius: 30,
                    spreadRadius: 5,
                  ),
                ],
          ...
          AnimatedBuilder(
            ...
            builder: (_, __) => Text(
              ...
              style: GoogleFonts.rajdhani(
                color: _neonPurple.withOpacity(0.6 + 0.4 * _glow.value),
                fontSize: 13,
                  ...
                  builder: (_, __) => Text(
                    ...
                    style: GoogleFonts.rajdhani(
                      color: (_isAutoCrop ? _neonCyan : Colors.white30)
                          .withOpacity(_isAutoCrop ? _glow.value : 0.5),
                      fontSize: 10,
                      fontWeight: FontWeight.w700,
                      letterSpacing: 2,
                    ),
                ...
                child: AnimatedBuilder(
                  ...
                  builder: (_, __) => Container(
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(18),
                      border: Border.all(
                        color: _neonPurple.withOpacity(0.12 * _glow.value),
                        width: 2,
                      ),
                    ),
                  ),
  ...
  Widget _buildBottomBar() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: _neonPurple.withOpacity(0.25), width: 1),
        boxShadow: [
          BoxShadow(
            ...
            child: GestureDetector(
              onTap: () async {
                ...
                try {
                  ...
                  Get.snackbar(
                    ...
                    backgroundColor: _neonPink.withOpacity(0.9),
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: _neonPurple.withOpacity(_cropping ? 0.2 : 0.5),
                      blurRadius: 18,
                      offset: const Offset(0, 4),
                    ),
                  ],
